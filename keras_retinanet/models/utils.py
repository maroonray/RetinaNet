...
def load_model(filepath, backbone='resnet50', convert=False, nms=True, anchor_config=None):
    ...
    if convert:
        model = retinanet_bbox(model=model, nms=nms, anchor_param=anchor_config)
